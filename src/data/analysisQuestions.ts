...
export const NEW_PROJECT_QUESTIONS: AnalysisQuestion[] = [
  ...
  },
  {
    ...
    allowCustom: true,
    customPlaceholder: 'e.g. AI chatbot, video calls, subscriptions…',
  },
  {
    id: 'platform',
  ...
  },
  {
    ...
    allowCustom: true,
    customPlaceholder: 'e.g. Multi-vendor, inventory, CRM…',
  },
  {
    id: 'timeline',
...
export const EXISTING_PROJECT_QUESTIONS: AnalysisQuestion[] = [
  {
    ...
    allowCustom: true,
    customPlaceholder: 'e.g. Desktop app, browser extension…',
  },
  {
    id: 'technologies',
    ...
    allowCustom: true,
    customPlaceholder: 'e.g. Next.js, Ruby on Rails, Unity…',
  },
  {
    id: 'working',
  ...
  },
  {
    ...
    allowCustom: true,
    customPlaceholder: 'e.g. Multi-language support, loyalty program…',
  },
  {
    id: 'projectLink',
