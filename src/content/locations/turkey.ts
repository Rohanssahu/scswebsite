/**
 * `/locations/turkey` — written for this page only.
 *
 * Turkish enquiries lean towards products with users on the outside: a
 * marketplace with two sides to keep honest, a booking or service platform, a
 * customer-service front end, an application that has to survive a promotion
 * weekend. They also arrive with a list of local services the product must
 * speak to — a payment provider, an SMS gateway, an accounting or e-invoice
 * system — and with a genuine language requirement, because the interface is
 * read in Turkish even when the project is run in English.
 *
 * So this page is organised around consumer-facing and marketplace products,
 * provider integrations scoped one by one, AI assistants and voice agents,
 * requirement-collection systems, and Turkish localization commissioned as
 * professional work.
 *
 * Deliberately different from the United Arab Emirates page, which is a
 * mobile-first single market with Arabic right-to-left interface engineering,
 * and from the Singapore page, which shares the two-and-a-half-hour clock gap
 * but is about multi-entity head-office operations rather than consumer scale.
 * Here the difference runs the other way round: Turkey is behind India, not
 * ahead of it.
 */

import type { LocationBody } from './types';

export const turkey: LocationBody = {
  path: '/locations/turkey',
  h1: 'Software and AI Development for Businesses in Turkey',
  valueProp:
  ...
  disclosure: {
    title: 'A development team in India, serving a Turkish market',
    body:
  ...
  concerns: {
    eyebrow: 'The first conversations',
    heading: 'What Turkish buyers check before committing',
    intro:
    ...
    items: [
      {
        title: 'Can you integrate our payment provider?',
        body:
      ...
      {
        title: 'Will it hold up on a campaign day?',
        body:
      ...
      {
        title: 'Who writes the Turkish text in the interface?',
        body:
      ...
      {
        title: 'How is the price handled if we sell in more than one currency?',
        body:
      ...
      {
        title: 'Where will customer data be stored?',
        body:
      ...
      {
        title: 'Can we change scope once the build has started?',
        body:
      ...
      {
        title: 'How much can a voice agent actually be trusted with?',
        body:
  ...
  services: {
    ...
    heading: 'The services Turkish projects most often need',
    intro:
    ...
    items: [
      {
        ...
        blurb:
          'Where most of these products are actually used: a customer application built for a first-time user on a mid-range phone and an ordinary mobile connection.',
      },
      {
        path: '/services/web-application-development',
        label: 'Web Application Development',
        blurb:
          'The public platform and the operations console behind it — listings, bookings, cases and the internal screens your team uses to keep them all moving.',
      },
      {
        path: '/services/custom-software-development',
        label: 'Custom Software Development',
        blurb:
          'Marketplace and settlement logic in particular: commission rules, payout timing, disputes and the ledger that has to reconcile at the end of every month.',
      },
      {
        path: '/services/saas-development',
        label: 'SaaS Development',
        blurb:
          'Subscription products for business customers: tenancy, plans, seats, trials, invoicing and the usage figures a renewal conversation depends on.',
      },
      {
        path: '/services/ai-voice-agent-development',
        label: 'AI Voice Agent Development',
        blurb:
          'Spoken assistance inside your own application or web product, with a defined set of permitted actions and a written rule for handing the caller to your team.',
      },
      {
        path: '/services/ai-video-consultation-agents',
        label: 'AI Video Consultation Agents',
        blurb:
          'Structured consultation and requirement collection: every enquiry asked the same questions, with a written summary a person reviews before anything is committed.',
      },
      {
        path: '/services/ai-development',
        label: 'AI Development',
        blurb:
          'Assistants grounded in your catalogue, policies and help material, answering with the source shown and escalating anything the material does not cover.',
      },
      {
        path: '/services/ai-automation-integration',
        label: 'AI Automation & Integration',
        blurb:
          'The provider integrations and the document and approval steps behind them — payments, messaging, invoicing and delivery, each with a record of what happened.',
      },
      {
        path: '/services/software-modernization',
        label: 'Software Modernization',
        blurb:
          'For a product that grew feature by feature and now breaks under its own weight: assessed, then rebuilt in releases that keep the existing users running.',
      },
    ],
  },
  projectTypes: {
    eyebrow: 'Common briefs',
    heading: 'Turkish projects that fit this way of working',
    intro:
    ...
    items: [
      {
        title: 'A marketplace with two sides to keep balanced',
        body:
      ...
      {
        title: 'A booking or appointment product where slots are money',
        body:
      ...
      {
        title: 'A customer-service platform that replaces a shared inbox',
        body:
      ...
      {
        title: 'Operational dashboards for a business that runs on daily numbers',
        body:
      ...
      {
        title: 'A voice or chat agent taking the repetitive half of enquiries',
        body:
      ...
      {
        title: 'Document and approval work still done by hand',
        body:
  ...
  collaboration: {
    ...
    heading: 'From requirement collection to a launched product',
    intro:
    ...
    steps: [
      {
        title: 'First call and an honest read on the idea',
        body:
      ...
      {
        title: 'Requirement collection and a written scope',
        body:
      ...
      {
        title: 'Design, agreement and accounts',
        body:
      ...
      {
        title: 'Build cycles and milestone reviews',
        body:
      ...
      {
        title: 'Launch, monitoring and what follows',
        body:
  ...
  communication: {
    eyebrow: 'Time and contact',
    heading: 'Two and a half hours, with India ahead of the Turkish clock',
    intro:
  ...
  security: {
    eyebrow: 'Data, hosting and money',
    heading: 'Hosting, currency and data questions closed before development',
    intro:
  ...
  oversight: {
    title: 'What a person still has to approve',
    body:
  ...
  localization: {
    title: 'Language: English project, Turkish interface as scoped work',
    body:
  ...
  engagement: {
    ...
    heading: 'How Turkish engagements are usually structured',
    intro:
    ...
    options: [
      {
        name: 'First version, fixed scope',
        body:
        ...
        bestFor: 'Suits a product that needs to reach real users before anything else is decided.',
      },
      {
        name: 'Ongoing product team',
        body:
        ...
        bestFor: 'Suits a live product where the roadmap changes with the numbers.',
      },
      {
        name: 'Single integration or agent build',
        body:
        ...
        bestFor: 'Suits adding one capability to a product that already exists.',
      },
    ],
  },
  faqs: [
    {
      question: 'Do you have an office, a branch or a registered company in Turkey?',
      answer:
    ...
    {
      question: 'Does your team speak Turkish?',
      answer:
    ...
    {
      question: 'How do the two working days actually line up?',
      answer:
    ...
    {
      question: 'Do you have a relationship with Turkish banks or payment providers?',
      answer:
    ...
    {
      question: 'Can you confirm the platform will satisfy the KVKK?',
      answer:
    ...
    {
      question: 'Do you hold any Turkish government approval, permit or certification?',
      answer:
    ...
    {
      question: 'How do you test that the product survives a campaign or a launch day?',
      answer:
    ...
    {
      question: 'Can you show us Turkish clients or local references?',
      answer:
  ...
  otherMarkets: [
    {
      ...
      label: 'United States',
      blurb:
        'A working day that barely meets ours, run on written scope, recorded approvals and a change process both sides can point at.',
    },
    {
      path: '/locations/united-kingdom',
      label: 'United Kingdom',
      blurb:
        'Organisations that buy software through a formal process: documented requirements, supplier checks and approval in stages.',
    },
    {
      path: '/locations/united-arab-emirates',
      label: 'United Arab Emirates',
      blurb:
        'A similar appetite for consumer apps in a single market, with Arabic right-to-left interface engineering priced on its own.',
    },
    {
      path: '/locations/canada',
      label: 'Canada',
      blurb:
        'Internal business platforms across a country with six clock offsets, where reachable hours are agreed client by client.',
    },
    {
      path: '/locations/australia',
      label: 'Australia',
      blurb:
        'Almost no shared working hours, so open test environments and written handovers carry what a meeting normally would.',
    },
    {
      path: '/locations/singapore',
      label: 'Singapore',
      blurb:
        'The same clock distance in the opposite direction, applied to head-office platforms spanning several entities and currencies.',
    },
    {
      path: '/locations/germany',
      label: 'Germany',
      blurb:
        'A full specification and acceptance criteria agreed before implementation, with documentation and release evidence as deliverables.',
    },
    {
      path: '/locations/netherlands',
      label: 'Netherlands',
      blurb:
        'Integration-led platforms joining systems already in daily use, decided in short written notes and proved every cycle.',
    },
  ],
  cta: {
    title: 'Tell us what your customers will be doing with it',
    body:
