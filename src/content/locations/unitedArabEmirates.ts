/**
 * `/locations/united-arab-emirates` — written for this page only.
 *
 * The UAE angle is again its own. The time-zone gap is small enough that the
 * working day is effectively shared, so the page spends its space on what UAE
 * enquiries are actually about: mobile-first customer experiences, booking and
 * service platforms, multi-branch dashboards, and Arabic interface work scoped
 * as a separate piece of delivery rather than implied as a house language.
 *
 * Nothing here claims a Dubai or Abu Dhabi presence, a UAE entity, UAE staff,
...
export const unitedArabEmirates: LocationContent = {
  ...
  disclosure: {
    title: 'Delivered from India, not from the Emirates',
    body:
  ...
  concerns: {
    ...
    heading: 'What UAE clients want settled before work starts',
    intro:
    ...
    items: [
      {
        title: 'How quickly a customer-facing app can be in market',
        body:
      ...
      {
        title: 'Whether the app will work for a customer on a phone in Arabic',
        body:
      ...
      {
        title: 'How payment, messaging and delivery integrations are handled',
        body:
      ...
      {
        title: 'Where the data will be hosted',
        body:
      ...
      {
        title: 'How several stakeholders approve one build',
        body:
      ...
      {
        title: 'Whether an AI assistant can be let near customers',
        body:
  ...
  services: {
    ...
    heading: 'The services most UAE projects draw on',
    intro:
    ...
    items: [
      {
        ...
        blurb:
          'The centre of most UAE builds: a customer app on iOS and Android, with payments, notifications, maps and an Arabic interface where the audience needs one.',
      },
      {
        path: '/services/web-application-development',
        label: 'Web Application Development',
        blurb:
          'Booking and service platforms, customer accounts, branch and franchise dashboards, and the admin tools your operations team works in daily.',
      },
      {
        path: '/services/custom-software-development',
        label: 'Custom Software Development',
        blurb:
          'Internal business systems for scheduling, dispatch, inventory or approvals, replacing whatever combination of sheets and messaging is holding it together now.',
      },
      {
        path: '/services/saas-development',
        label: 'SaaS Development',
        blurb:
          'A product sold to other businesses in the region: tenants, subscription plans, entitlements and the reporting an account manager needs.',
      },
      {
        path: '/services/software-modernization',
        label: 'Software Modernization',
        blurb:
          'A rework of an app or portal that launched years ago and no longer matches the brand, the phone screens or the volume it now handles.',
      },
      {
        path: '/services/ai-development',
        label: 'AI Development',
        blurb:
          'Assistants answering from your service catalogue, price list or policy documents, with retrieval, logging and a defined escalation to your staff.',
      },
      {
        path: '/services/ai-voice-agent-development',
        label: 'AI Voice Agent Development',
        blurb:
          'Spoken assistants inside your app or website for enquiries, availability and booking status, with interruption handling and a handover path.',
      },
      {
        path: '/services/ai-video-consultation-agents',
        label: 'AI Video Consultation Agents',
        blurb:
          'A guided video consultation that gathers a customer brief or intake details and produces a structured summary your team reviews afterwards.',
      },
      {
        path: '/services/ai-automation-integration',
        label: 'AI Automation & Integration',
        blurb:
          'Automating the back office behind the app: quotations, invoices, document checks and approvals, connected to the systems you already run.',
      },
    ],
  },
  projectTypes: {
    eyebrow: 'Project fit',
    heading: 'The UAE builds this suits',
    intro:
      'These are the project shapes that have worked well delivered remotely from Indore for clients in the region.',
    items: [
      {
        title: 'A booking or service app with real availability behind it',
        body:
      ...
      {
        title: 'A customer app on top of an existing shopfront business',
        body:
      ...
      {
        title: 'A multi-branch operations dashboard',
        body:
      ...
      {
        title: 'A bilingual customer-facing platform',
        body:
      ...
      {
        title: 'An AI assistant on the front of a service business',
        body:
      ...
      {
        title: 'Automation of a paperwork-heavy internal process',
        body:
  ...
  collaboration: {
    ...
    heading: 'From first conversation to a live product',
    intro:
    ...
    steps: [
      {
        title: 'Discovery call with the people who decide',
        body:
      ...
      {
        title: 'Scope, screens and integration list',
        body:
      ...
      {
        title: 'Design agreed on the phone screen first',
        body:
      ...
      {
        title: 'Build cycles and remote demonstrations',
        body:
      ...
      {
        title: 'Launch, monitoring and the next phase',
        body:
  ...
  security: {
    ...
    heading: 'Hosting, privacy and access, decided before build',
    intro:
  ...
  oversight: {
    title: 'Keeping a person in front of the customer',
    body:
  ...
  engagement: {
    eyebrow: 'Commercials',
    heading: 'How UAE engagements are usually arranged',
    intro:
    ...
    options: [
      {
        ...
        bestFor: 'Best for a first digital channel that needs to be live by a specific season or date.',
      },
      {
        name: 'Phased product roadmap',
        body:
        ...
        bestFor: 'Best when the business will learn from the first release before deciding the next.',
      },
      {
        name: 'Ongoing product support',
        body:
        ...
        bestFor: 'Best for a live app that needs to keep working while the business grows around it.',
      },
    ],
  },
  faqs: [
    {
      question: 'Do you have a Dubai or Abu Dhabi office?',
      answer:
    ...
    {
      question: 'Can you deliver the app in Arabic as well as English?',
      answer:
    ...
    {
      question: 'How different are our working hours?',
      answer:
    ...
    {
      question: 'Which payment gateways and local services can you integrate?',
      answer:
    ...
    {
      question: 'Can data stay hosted in the region?',
      answer:
    ...
    {
      question: 'Do you handle UAE licensing, regulatory or legal requirements?',
      answer:
    ...
    {
      question: 'How do we run demonstrations with several stakeholders?',
      answer:
  ...
  otherMarkets: [
    {
      ...
      label: 'United States',
      blurb:
        'A much larger time-zone gap, handled with an agreed overlap window, a written scope and a clickable build every cycle.',
    },
    {
