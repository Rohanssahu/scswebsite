/**
 * `/locations/singapore` — written for this page only.
 *
 * Singapore enquiries are rarely about a single application. They are usually
 * about a system that has to work across more than one market: several
 * entities, several currencies, several sets of rules, and a head-office team
 * that needs one view over all of it. So this page is organised around regional
 * operations, integration work, document and approval automation, and the
 * written decision trail those things depend on.
 *
 * Deliberately different from the United Arab Emirates page, which is about
 * consumer-facing mobile products in a single market. The two share a small
 * clock difference and nothing else.
 */

import type { LocationBody } from './types';

export const singapore: LocationBody = {
  path: '/locations/singapore',
  h1: 'Software and AI Development for Businesses in Singapore',
  valueProp:
  ...
  disclosure: {
    title: 'An India-based team serving a Singapore market',
    body:
  ...
  concerns: {
    eyebrow: 'The early conversation',
    heading: 'What Singapore buyers establish before committing',
    intro:
    ...
    items: [
      {
        title: 'Whether the system can serve more than one market',
        body:
      ...
      {
        title: 'How far the regional scope actually extends',
        body:
      ...
      {
        title: 'Whether we can integrate with what is already running',
        body:
      ...
      {
        title: 'Where the data will be hosted and who can reach it',
        body:
      ...
      {
        title: 'How decisions survive a distributed stakeholder group',
        body:
      ...
      {
        title: 'What an AI assistant is allowed to decide on its own',
        body:
  ...
  services: {
    ...
    heading: 'The services most Singapore engagements draw on',
    intro:
    ...
    items: [
      {
        ...
        blurb:
          'The core of most engagements here: an operations platform with entities, roles, approvals and reporting, used daily by staff in more than one country.',
      },
      {
        path: '/services/custom-software-development',
        label: 'Custom Software Development',
        blurb:
          'Internal workflow systems shaped around a process no package matches, including the reconciliations and handoffs currently done by hand at month end.',
      },
      {
        path: '/services/mobile-app-development',
        label: 'Mobile App Development',
        blurb:
          'Companion applications for staff and customers, built where a phone is genuinely the right surface rather than because a mobile app was on the plan.',
      },
      {
        path: '/services/saas-development',
        label: 'SaaS Development',
        blurb:
          'Products sold to other businesses in the region: tenancy, plans, seat management, billing and the usage data behind a commercial conversation.',
      },
      {
        path: '/services/ai-automation-integration',
        label: 'AI Automation & Integration',
        blurb:
          'Document handling and approval automation across the systems you already run — extraction, routing, sign-off and a complete record of each step.',
      },
      {
        path: '/services/ai-development',
        label: 'AI Development',
        blurb:
          'Assistants grounded in your own policies and documents, answering questions staff currently ask each other, with sources shown and a review path for anything material.',
      },
      {
        path: '/services/ai-voice-agent-development',
        label: 'AI Voice Agent Development',
        blurb:
          'Spoken assistance inside your own product or portal, with a bounded action set and a written rule for when the conversation is passed to your team.',
      },
      {
        path: '/services/ai-video-consultation-agents',
        label: 'AI Video Consultation Agents',
        blurb:
          'A structured video intake for enquiries or onboarding, producing a consistent written summary that a person checks before anything proceeds.',
      },
      {
        path: '/services/software-modernization',
        label: 'Software Modernization',
        blurb:
          'For a platform that grew market by market and now resists every change: assessed first, then restructured in releases the business can absorb.',
      },
    ],
  },
  projectTypes: {
    eyebrow: 'Typical briefs',
    heading: 'The Singapore projects that suit this arrangement',
    intro:
    ...
    items: [
      {
        title: 'A regional operations platform replacing spreadsheets',
        body:
      ...
      {
        title: 'A multi-entity workflow with real approval rules',
        body:
      ...
      {
        title: 'Dashboards over systems that do not talk to each other',
        body:
      ...
      {
        title: 'A regional SaaS product with paying tenants',
        body:
      ...
      {
        title: 'Document-heavy processes that still move by email',
        body:
      ...
      {
        title: 'An assistant over internal policy and product material',
        body:
  ...
  collaboration: {
    ...
    heading: 'From regional brief to a platform in service',
    intro:
    ...
    steps: [
      {
        title: 'Briefing call and market scoping',
        body:
      ...
      {
        title: 'Discovery, integration review and written scope',
        body:
      ...
      {
        title: 'Architecture, agreement and access',
        body:
      ...
      {
        title: 'Build cycles and stakeholder demonstrations',
        body:
      ...
      {
        title: 'Roll-out by market, handover and support',
        body:
  ...
  security: {
    eyebrow: 'Security and data location',
    heading: 'Hosting, access and processor decisions taken in discovery',
    intro:
  ...
  oversight: {
    title: 'The point where a person signs',
    body:
    ...
    options: [
      {
        ...
        bestFor: 'Suits a defined platform where the first market can prove the model.',
      },
      {
        name: 'Rolling delivery team',
        body:
        ...
        bestFor: 'Suits a platform that will keep absorbing new markets and processes.',
      },
      {
        name: 'Integration or automation package',
        body:
        ...
        bestFor: 'Suits a specific bottleneck rather than a whole platform.',
      },
    ],
  },
  faqs: [
    {
      question: 'Do you have an office or a registered company in Singapore?',
      answer:
    ...
    {
      question: 'How does the time difference work in practice?',
      answer:
    ...
    {
      question: 'Can you build a system that serves our other markets in the region?',
      answer:
    ...
    {
      question: 'Can the platform be hosted in Singapore?',
      answer:
    ...
    {
      question: 'Do you hold a PDPA certification, or an assurance pack we can review?',
      answer:
    ...
    {
      question: 'Have you worked with financial institutions or government agencies here?',
      answer:
    ...
    {
      question: 'How do decisions get recorded when stakeholders are in different countries?',
      answer:
  ...
  otherMarkets: [
    {
      ...
      label: 'United States',
      blurb:
        'Remote engineering across a much larger gap, with ownership, accountability and change control settled before signing.',
    },
    {
      path: '/locations/united-kingdom',
      label: 'United Kingdom',
      blurb:
        'Documented requirements, supplier due diligence and staged approvals for organisations that buy software carefully.',
    },
    {
      path: '/locations/united-arab-emirates',
      label: 'United Arab Emirates',
      blurb:
        'Customer-facing mobile products for a single market, with Arabic interface work scoped and quoted on its own.',
    },
    {
      path: '/locations/canada',
      label: 'Canada',
      blurb:
        'Internal business platforms delivered across a wide spread of clock offsets, with reachable hours written into the engagement.',
    },
    {
