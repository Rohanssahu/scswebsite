/**
 * `/locations/australia` — written for this page only.
 *
 * Australian enquiries arrive with a different centre of gravity to the North
 * American and European ones. The clock gap is small and favourable, so the
 * conversation moves quickly past "when can we talk" and onto the mechanics:
 * how a requirement gets approved, which environment a stakeholder can open to
 * check it, when a release happens, and who is looking after the product in the
 * quarter after launch. This page is organised around those four things.
 *
 * The daylight-saving split matters here and is stated accurately: three of the
 * eastern states and the ACT move their clocks, Queensland, the Northern
 * Territory and Western Australia do not, so no single overlap fits the whole
 * country and none is promised.
 */

import type { LocationBody } from './types';

export const australia: LocationBody = {
  path: '/locations/australia',
  h1: 'Remote Software and AI Development for Australian Businesses',
  valueProp:
  ...
  disclosure: {
    title: 'Delivered from India, with nothing on the ground here',
    body:
  ...
  concerns: {
    ...
    heading: 'What Australian clients want pinned down before we start',
    intro:
    ...
    items: [
      {
        title: 'Which hours we will actually be online together',
        body:
      ...
      {
        title: 'How a requirement becomes something we are allowed to build',
        body:
      ...
      {
        title: 'Whether stakeholders can see the work in progress',
        body:
      ...
      {
        title: 'How a release is planned and reversed if needed',
        body:
      ...
      {
        title: 'Where the product and its data will be hosted',
        body:
      ...
      {
        title: 'Who looks after it once it is live',
        body:
  ...
  services: {
    ...
    heading: 'The services behind an Australian product build',
    intro:
    ...
    items: [
      {
        ...
        blurb:
          'iOS and Android applications, taken through store review, payments, notifications and the offline behaviour a customer in a low-signal area will run into.',
      },
      {
        path: '/services/web-application-development',
        label: 'Web Application Development',
        blurb:
          'Booking and service platforms, customer accounts, scheduling and the operations screens your staff use behind them, with roles and audit trails included.',
      },
      {
        path: '/services/custom-software-development',
        label: 'Custom Software Development',
        blurb:
          'When the requirement does not match a category: a system built to the way your business actually runs, with the integrations it needs to stay in step with the rest of your tools.',
      },
      {
        path: '/services/saas-development',
        label: 'SaaS Development',
        blurb:
          'Multi-tenant products with plans, seats, trials, billing and the usage reporting a subscription business needs before it can price anything confidently.',
      },
      {
        path: '/services/software-modernization',
        label: 'Software Modernization',
        blurb:
          'Rebuilding a live product without switching it off: assessment, a staged plan, and changes released in sequence while customers keep using it.',
      },
      {
        path: '/services/ai-development',
        label: 'AI Development',
        blurb:
          'AI-assisted steps inside a product that already works — drafting, summarising, classifying — with grounding in your own content and a person on the other side of anything consequential.',
      },
      {
        path: '/services/ai-voice-agent-development',
        label: 'AI Voice Agent Development',
        blurb:
          'Spoken interaction inside your application, with interruption handling, a bounded set of actions and a documented point at which the conversation goes to a person.',
      },
      {
        path: '/services/ai-video-consultation-agents',
        label: 'AI Video Consultation Agents',
        blurb:
          'A guided video intake that gathers information consistently and hands your team a structured summary to review, rather than a recording nobody watches.',
      },
      {
        path: '/services/ai-automation-integration',
        label: 'AI Automation & Integration',
        blurb:
          'Connecting the systems you already run and automating the handoffs between them, with approval gates and a record of every automated action.',
      },
    ],
  },
  projectTypes: {
    eyebrow: 'Good fits',
    heading: 'The Australian work this arrangement handles well',
    intro:
    ...
    items: [
      {
        title: 'A booking or service platform that has outgrown its first build',
        body:
      ...
      {
        title: 'A customer mobile app with a business system behind it',
        body:
      ...
      {
        title: 'A SaaS application moving from one customer to many',
        body:
      ...
      {
        title: 'Business dashboards that leadership will actually rely on',
        body:
      ...
      {
        title: 'A live product that needs modernising underneath',
        body:
      ...
      {
        title: 'An AI-assisted workflow inside an existing product',
        body:
  ...
  collaboration: {
    eyebrow: 'The rhythm',
    heading: 'From first workshop to a released product',
    intro:
    ...
    steps: [
      {
        title: 'Introductory workshop and window scheduling',
        body:
      ...
      {
        title: 'Requirement definition and approval',
        body:
      ...
      {
        title: 'Architecture, environments and commercial terms',
        body:
      ...
      {
        title: 'Build cycles, review and user acceptance testing',
        body:
      ...
      {
        title: 'Release planning, launch and the support arrangement',
        body:
  ...
  communication: {
    eyebrow: 'Shared hours',
    heading: 'Working across a moving clock difference',
    intro:
  ...
  security: {
    eyebrow: 'Hosting and privacy',
    heading: 'Settling data-hosting requirements before the architecture',
    intro:
  ...
  oversight: {
    title: 'Keeping a person between the model and the customer',
    body:
  ...
  engagement: {
    ...
    heading: 'Typical commercial arrangements for Australian projects',
    intro:
    ...
    options: [
      {
        ...
        bestFor: 'Suits a launch with a date attached and a requirement that is already understood.',
      },
      {
        name: 'Continuing product team',
        body:
        ...
        bestFor: 'Suits a live product that will keep changing after launch.',
      },
      {
        name: 'Support and improvement agreement',
        body:
        ...
        bestFor: 'Suits a released product that needs looking after rather than rebuilding.',
      },
    ],
  },
  faqs: [
    ...
    {
      question: 'How much of the Australian working day do we share?',
      answer:
    ...
    {
      question: 'Do you provide support outside those hours?',
      answer:
    ...
    {
      question: 'Can the application be hosted in Australia?',
      answer:
    ...
    {
      question: 'Can you confirm the product will meet the Privacy Act?',
      answer:
    ...
    {
      question: 'Can our stakeholders review the work as it is built?',
      answer:
  ...
  otherMarkets: [
    ...
    },
    {
      ...
      blurb:
        'Requirements documented for supplier assurance, approvals taken in stages, and maintenance arranged before a service goes live.',
    },
    {
      path: '/locations/united-arab-emirates',
      label: 'United Arab Emirates',
      blurb:
        'Consumer-facing applications for a market whose working day nearly matches ours, with Arabic interface work quoted separately.',
    },
    {
      path: '/locations/canada',
      label: 'Canada',
      blurb:
        'Internal platforms and portals across six clock offsets, with reachable hours and acceptance criteria fixed in writing first.',
    },
    {
