/**
 * `/locations/netherlands` — written for this page only.
 *
 * Dutch enquiries are rarely about one application in isolation. They are about
 * the seams: an order system, a warehouse, an accounting package, a portal and
 * three SaaS subscriptions that each hold part of the answer, and a business
 * that needs them to behave as one thing. So this page is organised around
 * integration-led platforms, APIs, dashboards and operational tooling, products
 * configured for more than one market, and a decision rhythm that is short,
 * written and demonstrated rather than documented at length in advance.
 *
 * Deliberately different from the Germany page, which shares the same clock but
 * is organised around a full specification and acceptance criteria settled
 * before implementation. Here the emphasis is the opposite way round: decide
 * quickly, write the decision down in a paragraph, and prove it in the next
 * demonstration.
 *
 * Also deliberately different from the Singapore page. Both mention more than
 * one market, but Singapore is about several legal entities and currencies under
 * one head office, while this page is about one product configured differently
 * per market it is sold into.
 */

import type { LocationBody } from './types';

export const netherlands: LocationBody = {
  path: '/locations/netherlands',
  h1: 'Software and AI Development for Businesses in the Netherlands',
  valueProp:
  ...
  disclosure: {
    title: 'Remote delivery from India, for a Dutch market',
    body:
  ...
  concerns: {
    eyebrow: 'What gets asked early',
    heading: 'The things a Dutch buyer wants settled in the first two calls',
    intro:
    ...
    items: [
      {
        title: 'Can you actually connect to what we already run?',
        body:
      ...
      {
        title: 'How fast does a decision get made?',
        body:
      ...
      {
        title: 'When do we get to see something real?',
        body:
      ...
      {
        title: 'We sell in several countries — can one product handle that?',
        body:
      ...
      {
        title: 'Where will the data live and who can reach it?',
        body:
      ...
      {
        title: 'Do you cover the whole of the EU?',
        body:
      ...
      {
        title: 'What is an AI feature allowed to do unsupervised?',
        body:
  ...
  services: {
    ...
    heading: 'What Dutch engagements are usually made of',
    intro:
    ...
    items: [
      {
        ...
        blurb:
          'The operational platform at the centre of most of this work: orders, jobs, stock or cases, plus the screens the team actually lives in all day.',
      },
      {
        path: '/services/ai-automation-integration',
        label: 'AI Automation & Integration',
        blurb:
          'The interfaces and the reconciliation logic that make separate systems agree, with the failure handling and retry behaviour designed rather than discovered.',
      },
      {
        path: '/services/saas-development',
        label: 'SaaS Development',
        blurb:
          'Products sold on subscription: tenancy, plans, seats, trials, metering and the usage data you need before a pricing conversation is worth having.',
      },
      {
        path: '/services/custom-software-development',
        label: 'Custom Software Development',
        blurb:
          'Where the process is genuinely yours and no subscription fits it — including the manual steps between systems that nobody has ever written down.',
      },
      {
        path: '/services/software-modernization',
        label: 'Software Modernization',
        blurb:
          'For software that still works but is no longer safe to change: measured first, then restructured release by release, with the integrations kept alive throughout.',
      },
      {
        path: '/services/mobile-app-development',
        label: 'Mobile App Development',
        blurb:
          'Applications for drivers, engineers, warehouse staff or customers, built where a phone is the natural device rather than a second version of the web screens.',
      },
      {
        path: '/services/ai-development',
        label: 'AI Development',
        blurb:
          'Assistants grounded in your own documentation and data, answering with citations, and handing anything they cannot support to a person instead of improvising.',
      },
      {
        path: '/services/ai-voice-agent-development',
        label: 'AI Voice Agent Development',
        blurb:
          'Spoken interaction inside your own product, with a fixed set of permitted actions and a written rule for when a human takes the conversation over.',
      },
      {
        path: '/services/ai-video-consultation-agents',
        label: 'AI Video Consultation Agents',
        blurb:
          'A structured video intake that collects the same information from every enquiry and produces a written summary a person checks before it goes anywhere.',
      },
    ],
  },
  projectTypes: {
    eyebrow: 'Typical briefs',
    heading: 'Dutch projects this arrangement suits well',
    intro:
    ...
    items: [
      {
        title: 'An integration layer between systems that half-talk',
        body:
      ...
      {
        title: 'Operational dashboards that finally agree with each other',
        body:
      ...
      {
        title: 'One product sold into several markets',
        body:
      ...
      {
        title: 'A subscription product built on top of internal software',
        body:
      ...
      {
        title: 'A portal that removes a queue of email requests',
        body:
      ...
      {
        title: 'Workflow automation across the handovers nobody owns',
        body:
  ...
  collaboration: {
    ...
    heading: 'Short cycles, written decisions, something to click on',
    intro:
    ...
    steps: [
      {
        title: 'First call and a straight answer',
        body:
      ...
      {
        title: 'Discovery focused on the seams',
        body:
      ...
      {
        title: 'Setup: agreement, environments and access',
        body:
      ...
      {
        title: 'Build, demonstrate, decide, record — on repeat',
        body:
      ...
      {
        title: 'Release, transfer and what happens next',
        body:
  ...
  communication: {
    eyebrow: 'Hours and contact',
    heading: 'A long overlap, used for deciding rather than reporting',
    intro:
  ...
  security: {
    eyebrow: 'Data, access and hosting',
    heading: 'Processing and hosting decisions taken during discovery',
    intro:
  ...
  oversight: {
    title: 'The human step in an automated chain',
    body:
  ...
  localization: {
    title: 'Language: English delivery, Dutch localization scoped separately',
    body:
  ...
  engagement: {
    ...
    heading: 'How Dutch engagements are normally arranged',
    intro:
    ...
    options: [
      {
        ...
        bestFor: 'Suits a clear first outcome you want in service before committing further.',
      },
      {
        ...
        bestFor: 'Suits a platform that will keep growing once the first release is live.',
      },
      {
        name: 'Single integration or dashboard',
        body:
        ...
        bestFor: 'Suits a specific bottleneck you already know the shape of.',
      },
    ],
  },
  faqs: [
    {
      question: 'Do you have an office or a registered company in the Netherlands?',
      answer:
    ...
    {
      question: 'Does anyone on the team speak Dutch?',
      answer:
    ...
    {
      question: 'How much of the working day do we actually share?',
      answer:
    ...
    {
      question: 'Can you tell us the platform will be GDPR compliant?',
      answer:
    ...
    {
      question: 'Are you approved or supervised by any Dutch authority?',
      answer:
    ...
    {
      question: 'What happens if a third-party system we depend on has no proper API?',
      answer:
    ...
    {
      question: 'Can the same product serve our German and Belgian customers as well?',
      answer:
    ...
    {
      question: 'Do you have Dutch clients or local partners we could speak to?',
      answer:
  ...
  otherMarkets: [
    {
      ...
      label: 'United States',
      blurb:
        'Almost no shared working day, so accountability, change control and written approval carry the engagement instead of conversation.',
    },
    {
      path: '/locations/united-kingdom',
      label: 'United Kingdom',
      blurb:
        'A formal buying process: documented requirements, supplier checks and staged sign-off before a build is authorised.',
    },
    {
      path: '/locations/united-arab-emirates',
      label: 'United Arab Emirates',
      blurb:
        'Mobile-first consumer products in a single market, with Arabic interface engineering quoted as work of its own.',
    },
    {
      path: '/locations/canada',
      label: 'Canada',
      blurb:
        'One country spread across six clock offsets, where which hours we are reachable is negotiated rather than assumed.',
    },
    {
      path: '/locations/australia',
      label: 'Australia',
      blurb:
        'Barely overlapping working days, handled with open test environments and handover notes that replace the missing meeting.',
    },
    {
      path: '/locations/singapore',
      label: 'Singapore',
      blurb:
        'Head-office platforms covering several legal entities and currencies, with approvals recorded for stakeholders spread across the region.',
    },
    {
      path: '/locations/germany',
      label: 'Germany',
      blurb:
        'The same working hours, approached the other way round: a full specification and acceptance criteria agreed before implementation begins.',
    },
    {
      path: '/locations/turkey',
      label: 'Turkey',
      blurb:
        'Customer-facing marketplaces and booking products, AI voice agents, and Turkish localization commissioned as professional work.',
    },
  ],
  cta: {
    title: 'Bring us the list of systems, not just the wish',
    body:
