/**
 * `/locations/united-states` — written for this page only.
 *
 * The angle here is the one US enquiries actually arrive with: a build that has
 * to happen faster than a domestic hire allows, and a buyer who wants the
 * accountability, ownership and change-control questions answered before
 * signing with a team on the other side of the world. Nothing on this page is
...
export const unitedStates: LocationBody = {
  ...
  disclosure: {
    title: 'Where SCS Softwares actually is',
    body:
  ...
  concerns: {
    ...
    heading: 'The questions US buyers ask us first',
    intro:
    ...
    items: [
      {
        title: 'Who is accountable when something breaks',
        body:
      ...
      {
        title: 'Who owns the code and the accounts',
        body:
      ...
      {
        title: 'How the time-zone gap is actually handled',
        body:
      ...
      {
        title: 'Where the data will live and who can reach it',
        body:
      ...
      {
        title: 'Whether the estimate will hold',
        body:
      ...
      {
        title: 'Whether AI output can be trusted in production',
        body:
  ...
  services: {
    eyebrow: 'Where US projects usually start',
    heading: 'The services behind a United States engagement',
    intro:
    ...
    items: [
      {
        ...
        blurb:
          'The usual entry point for a US engagement: an application built for one business process, replacing the spreadsheet-and-email arrangement it grew out of.',
      },
      {
        path: '/services/mobile-app-development',
        label: 'Mobile App Development',
        blurb:
          'iOS and Android builds, including the parts US launches actually stall on — store review, payments, push notifications and offline behaviour.',
      },
      {
        path: '/services/web-application-development',
        label: 'Web Application Development',
        blurb:
          'Customer portals, dashboards, marketplaces and booking flows, with the APIs, roles and admin tooling that have to exist behind them.',
      },
      {
        path: '/services/saas-development',
        label: 'SaaS Development',
        blurb:
          'Subscription products from first release to multi-tenant platform: plans, billing, roles, usage limits and the architecture underneath them.',
      },
      {
        path: '/services/software-modernization',
        label: 'Software Modernization',
        blurb:
          'For the system that already runs the business and cannot be switched off: assessment first, then incremental change against live traffic.',
      },
      {
        path: '/services/ai-development',
        label: 'AI Development',
        blurb:
          'Assistants, retrieval over your own content and structured AI workflows, with the monitoring, cost controls and review steps around them.',
      },
      {
        path: '/services/ai-voice-agent-development',
        label: 'AI Voice Agent Development',
        blurb:
          'Real-time spoken conversation inside your product, with interruption handling, a defined tool set and a documented escalation to your team.',
      },
      {
        path: '/services/ai-video-consultation-agents',
        label: 'AI Video Consultation Agents',
        blurb:
          'An avatar-led consultation room that gathers requirements or intake details and produces a structured summary a person reviews afterwards.',
      },
      {
        path: '/services/ai-automation-integration',
        label: 'AI Automation & Integration',
        blurb:
          'Document processing, structured extraction and workflow automation wired into the systems you already run, with approvals and an audit trail.',
      },
    ],
  },
  projectTypes: {
    eyebrow: 'Project fit',
    heading: 'What US clients bring us',
    intro:
    ...
    items: [
      {
        title: 'A first product release with a fixed window',
        body:
      ...
      {
        title: 'An internal tool that outgrew its spreadsheet',
        body:
      ...
      {
        title: 'A platform that needs a second engineering team',
        body:
      ...
      {
        title: 'An AI feature inside an existing product',
        body:
      ...
      {
        title: 'A system nobody wants to touch any more',
        body:
      ...
      {
        title: 'Integration work between systems that never spoke',
        body:
  ...
  collaboration: {
    ...
    steps: [
      ...
      {
        title: 'Remote discovery and written scope',
        body:
      ...
      {
        title: 'Commercials, access and kick-off',
        body:
      ...
      {
        title: 'Build cycles with milestone demonstrations',
        body:
      ...
      {
        title: 'Release, handover and ongoing support',
        body:
  ...
  communication: {
    ...
    heading: 'Overlap, meetings and the written trail',
    intro:
  ...
  security: {
    ...
    heading: 'How data, access and privacy questions are handled',
    intro:
  ...
  oversight: {
    title: 'Human review over AI output',
    body:
    ...
    options: [
      {
        ...
        bestFor: 'Best when the outcome is clear and the budget has to be committed in advance.',
      },
      {
        ...
        bestFor: 'Best for a roadmap that will change, or an ongoing second engineering team.',
      },
      {
        name: 'Assessment first, then decide',
        body:
        ...
        bestFor: 'Best when you inherited a system and need an outside read before committing.',
      },
    ],
  },
  faqs: [
    {
      question: 'Does SCS Softwares have a United States office?',
      answer:
    ...
    {
      question: 'Can you work with a US company that has never hired offshore before?',
      answer:
    ...
    {
      question: 'How much overlap with US working hours can we expect?',
      answer:
    ...
    {
      question: 'Are you HIPAA or SOC 2 compliant?',
      answer:
    ...
    {
      question: 'Which US laws apply to the contract?',
      answer:
    ...
    {
      question: 'What does the first two weeks look like?',
      answer:
  ...
  otherMarkets: [
    {
      ...
      blurb:
        'The same team, a shorter time-zone gap and a delivery rhythm built around documented requirements and staged approvals.',
    },
    {
