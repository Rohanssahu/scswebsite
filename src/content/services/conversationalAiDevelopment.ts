 ...
 * this one is about conversation design, grounding, tools and handoff wherever
...
export const conversationalAiDevelopment: ServiceBody = {
  ...
  problems: {
    ...
    heading: 'The problems a conversational assistant solves',
    intro:
      'Every one of these is a case where the answer already exists somewhere and the person asking cannot reach it.',
    items: [
      {
        title: 'Support answers the same questions forever',
        body: 'Delivery times, refunds, setup steps, plan differences. The answers are documented, findable in theory, and asked anyway — because reading a help centre is slower than asking.',
      },
      {
        title: 'The documentation is good and nobody reads it',
        body: 'A search box that matches keywords returns twelve articles. What the user wanted was one sentence and a link, phrased against their actual situation.',
      },
      {
        title: 'Enquiry forms lose the people they are meant to capture',
        body: 'A long form asks for information the visitor has not decided yet. A conversation asks one thing at a time, explains why, and adapts to the answers.',
      },
      {
        title: 'Users cannot find features they already pay for',
        body: 'Functionality buried three menus deep. An in-product assistant lets someone describe what they want to do and be taken there, or have it done for them.',
      },
      {
        title: 'An existing bot has made the experience worse',
        body: 'A scripted widget that misroutes people, cannot be escaped, and hides the human contact route. Replacing it is often a bigger win than adding anything new.',
      },
    ],
  },
  useCases: {
    eyebrow: 'What it is used for',
    heading: 'Conversational systems we build',
    intro:
    ...
    items: [
      {
        ...
        body: 'Answering pre-sales questions from your own pages and documentation, with sources attached, and routing serious enquiries to your team with what has already been said.',
      },
      {
        title: 'In-app assistants',
        body: 'Embedded in your product, aware of who is signed in and what they can access, able to explain a feature or perform a permitted action on request.',
      },
      {
        title: 'Knowledge-grounded internal chat',
        body: 'Staff asking questions of policies, procedures, product data and past tickets, with permission-aware retrieval so answers respect existing access rules.',
      },
      {
        title: 'Guided requirement collection',
        body: 'Structured intake through conversation — scope, constraints, context — captured into fields your team or your pricing logic can use directly.',
      },
      {
        title: 'Customer support workflows',
        body: 'Handling the repetitive tier-one cases end to end: order status, account questions, resets and simple changes, with anything unusual escalated intact.',
      },
      {
        title: 'Lead qualification and routing',
        body: 'Establishing fit and intent conversationally, scoring the result against your criteria, and delivering the enquiry to the right person with context attached.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'What we build',
    heading: 'Capabilities of a conversational system',
    intro:
    ...
    groups: [
      {
        ...
        body: 'The difference between an assistant that helps and one that invents.',
        items: [
      ...
      },
      {
        ...
        body: 'A conversation that goes somewhere, rather than one that merely continues.',
        items: [
      ...
      {
        title: 'Tools, actions and backend access',
        body: 'What the assistant can do is defined in code, and nothing wider is reachable.',
        items: [
      ...
      {
        title: 'Channels',
        body: 'One conversation design, deployed where your users already are.',
        items: [
      ...
      },
      {
        ...
        body: 'Supported where configured, and scoped per language rather than promised in general.',
        items: [
      ...
      {
        title: 'Guardrails, evaluation and handoff',
        body: 'The operational half, which determines whether the assistant is still trusted in month three.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'Our approach to conversational AI',
    intro:
  ...
  process: {
    ...
    heading: 'How a conversational AI project runs',
    intro:
    ...
    steps: [
      {
        ...
        body: 'We look at what people actually ask and what material exists to answer them, and are honest when the gap is large.',
        points: [
      ...
      {
        title: 'Architecture and conversation design',
        body: 'Retrieval design and conversation flow are decided together, along with what the user sees while waiting.',
        points: [
      ...
      },
      {
        ...
        body: 'The assistant is built against your real systems, with the tools it needs and nothing more.',
        points: [
      ...
      },
      {
        ...
        body: 'Measured against a fixed set of real questions, and tested by people trying to break it.',
        points: [
      ...
      {
        title: 'Launch, monitoring and improvement',
        body: 'The questions it cannot answer in month one are the roadmap for month two.',
        points: [
  ...
  integration: {
    eyebrow: 'Integration',
    heading: 'Connecting the assistant to your systems',
    intro:
  ...
  limitations: {
    ...
    heading: 'What a conversational assistant cannot do',
    intro:
  ...
  engagement: {
    ...
    heading: 'Engagement options for assistants',
    intro:
      'Assistants improve fastest when they meet real questions early, so we favour a narrow first launch.',
    options: [
      {
        name: 'Focused assistant',
        body: 'One conversation type on one channel — support deflection, pre-sales questions or guided intake — grounded, integrated and launched to a limited audience.',
        bestFor: 'Best for proving value on a specific, measurable question set.',
      },
      {
        name: 'Multi-channel assistant',
        body: 'Several conversation types across web, product and voice, with deeper tool integration, handoff paths and analytics for your team.',
        bestFor: 'Best once a focused assistant has earned its place.',
      },
      {
        name: 'Ongoing conversation operations',
        body: 'Monthly capacity for grounding updates, evaluation runs, new conversation types, provider migrations and cost tuning.',
        bestFor: 'Best for an assistant carrying real conversation volume.',
      },
    ],
  },
  security: {
    eyebrow: 'Security and privacy',
    heading: 'Security considerations for assistants',
    intro:
  ...
  faqs: [
    {
      question: 'How is this different from the chatbot we already have?',
      answer:
    ...
    {
      question: 'Can it do things, or only answer questions?',
      answer:
    ...
    {
      question: 'How do we know whether it is working?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The AI pillar: retrieval, structured workflows, evaluation and the controls around them.',
    },
    {
      path: '/services/ai-voice-agent-development',
      label: 'AI Voice Agent Development',
      blurb: 'The same conversation design delivered as real-time speech rather than text.',
    },
    {
      path: '/services/ai-video-consultation-agents',
      label: 'AI Video Consultation Agents',
      blurb: 'A live avatar-led room when the first conversation deserves more than a chat panel.',
    },
    {
      path: '/services/ai-automation-integration',
      label: 'AI Automation & Integration',
      blurb: 'What happens after the conversation: records created, tasks raised, approvals routed.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'The product the assistant is embedded in, and the admin tooling behind it.',
    },
    {
      path: '/services/saas-development',
      label: 'SaaS Development',
      blurb: 'In-product assistants for multi-tenant software, scoped correctly per tenant.',
    },
  ],
  cta: {
    title: 'Know what your users keep asking?',
    body: 'That question list is the start of the project. Get an indicative estimate, talk it through with our AI consultation agent, or send it to the team.',
  },
};
