...
export const customSoftwareDevelopment: ServiceContent = {
  ...
  problems: {
    ...
    heading: 'The problems custom software usually solves',
    intro:
    ...
    items: [
      {
        title: 'A product idea with no engineering team behind it',
        body: 'You know what the product should do and who it is for, but there is no one to turn it into an architecture, a schedule and a shipped release. We take the idea through discovery, scope it into releases, and build it.',
      },
      {
        title: 'Manual work that has quietly become a department',
        body: 'Data re-keyed between systems, approvals chased over email, reports assembled by hand at the end of every month. Automating those steps usually pays for itself faster than any new feature would.',
      },
      {
        title: 'Systems that will not talk to each other',
        body: 'A CRM, an accounting package, a payment provider and a warehouse tool that each hold part of the truth. We build the integrations and the reconciliation logic so one record means one thing.',
      },
      {
        title: 'Software that outgrew whoever built it',
        body: 'A build from an earlier agency or a former in-house developer that now takes days to change and breaks in unexpected places. We assess it before proposing anything, then modernise it in steps.',
      },
      {
        title: 'Internal tools that never got prioritised',
        body: 'Operations, support and finance teams often run on tools nobody owns. Purpose-built internal software removes an entire category of daily friction and human error.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'What we build',
    heading: 'Solutions and platforms we support',
    intro:
    ...
    groups: [
      {
        ...
        body: 'Greenfield builds, from the first release that proves the idea through to the version that carries real users.',
        items: [
      ...
      },
      {
        ...
        body: 'Replacing repeated manual steps with software that runs them the same way every time and leaves an audit trail.',
        items: [
      ...
      {
        title: 'Internal tools and customer platforms',
        body: 'The two sides of most operations work: what your staff use, and what your customers see.',
        items: [
      ...
      },
      {
        ...
        body: 'Connecting your build to the services that already hold your data or take your payments.',
        items: [
      ...
      },
      {
        ...
        body: 'The AI work we do ourselves and run in production on this site, applied to your product where it earns its place.',
        items: [
      ...
      {
        title: 'Modernisation of existing systems',
        body: 'Taking an application you already depend on and making it maintainable again, in stages.',
        items: [
  ...
  process: {
    eyebrow: 'Discovery through delivery',
    heading: 'From first conversation to running software',
    intro:
    ...
    steps: [
      {
        ...
        body: 'We start by understanding the process the software has to serve, not the feature list. That means the people who will use it, the systems it has to reach, and the rules nobody wrote down.',
        points: [
      ...
      },
      {
        ...
        body: 'Before code, two things get decided: how the system is structured, and what people actually see. Both are reviewed with you while they are still cheap to change.',
        points: [
      ...
      },
      {
        ...
        body: 'Build happens in short cycles against the agreed priorities, with third-party integrations treated as first-class work rather than an afterthought at the end.',
        points: [
      ...
      },
      {
        ...
        body: 'Testing runs alongside development. What we can automate, we automate; the rest is checked by hand against the scope that was agreed.',
        points: [
      ...
      },
      {
        ...
        body: 'Release is a procedure, not an event: environments, migrations and a way back if something goes wrong. After launch, support continues under an agreed arrangement.',
        points: [
    ...
    options: [
      {
        ...
        body: 'A defined scope, an agreed price and a schedule of milestones. Changes are quoted separately, so the baseline stays meaningful.',
        bestFor: 'Best when requirements are clear enough to write down in full.',
      },
      {
        name: 'Dedicated team',
        body: 'Named developers, designers and QA working to your priorities for an agreed period, with the backlog reordered as you learn.',
        bestFor: 'Best for ongoing product work and evolving roadmaps.',
      },
      {
        name: 'Support and maintenance',
        body: 'An agreed block of monthly capacity for fixes, small improvements, dependency updates and platform changes.',
        bestFor: 'Best after launch, or for software someone else built.',
      },
    ],
  },
  security: {
    eyebrow: 'Security',
    heading: 'How we handle security and your data',
    intro:
  ...
  faqs: [
    {
      question: 'What does custom software development actually include?',
      answer:
    ...
    {
      question: 'How do you work with clients in other countries?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'iOS and Android applications in React Native, Flutter or native code, with the integrations they depend on.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'Portals, dashboards, marketplaces and booking systems, with APIs and admin tooling behind them.',
    },
    {
      path: '/services/saas-development',
      label: 'SaaS Development',
      blurb: 'Multi-tenant products with subscriptions, roles, usage tracking and a first release you can put in front of users.',
    },
    {
  ...
  cta: {
    ...
    body: 'Start with an indicative estimate, talk it through with our AI consultation agent, or send the details straight to the team in Indore. All three reach the same people.',
  },
};
