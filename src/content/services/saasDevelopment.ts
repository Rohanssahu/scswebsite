...
export const saasDevelopment: ServiceContent = {
  ...
  problems: {
    ...
    heading: 'The problems that shape a SaaS build',
    intro:
      'SaaS projects go wrong in recognisable ways. These are the ones worth designing against from the beginning.',
    items: [
      {
        title: 'The MVP is not minimal and not viable',
        body: 'Either it carries a year of roadmap and never ships, or it is stripped so far it proves nothing. Scoping the first release around one workflow, end to end, is the single most useful decision in the project.',
      },
      {
        title: 'Tenancy was an afterthought',
        body: 'Separating one customer’s data from another after launch means touching every query and every screen. Deciding the tenancy model up front costs a conversation; retrofitting it costs a rewrite.',
      },
      {
        title: 'Billing does not match the product',
        body: 'Plans, seats, trials, upgrades mid-cycle, proration, failed payments and dunning. Billing is a system in its own right, and it fails in ways customers notice immediately.',
      },
      {
        title: 'Nobody knows what users do inside the product',
        body: 'Without usage tracking, roadmap decisions come down to whoever argued most recently. Instrumentation is cheap to add during the build and awkward to add later.',
      },
      {
        title: 'Growth arrived at the wrong layer',
        body: 'One heavy tenant, one unindexed query or one synchronous export can slow the product for everyone. The fix is usually structural, so the structure is worth getting right early.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'Platforms and solutions',
    heading: 'What a SaaS build includes',
    intro:
      'The building blocks below are ones we implement directly on SaaS projects.',
    groups: [
      {
        title: 'MVP and first release',
        body: 'Getting a real product in front of real users while the assumptions are still cheap to change.',
        items: [
      ...
      },
      {
        ...
        body: 'The decision that everything else in the product is built on top of.',
        items: [
      ...
      },
      {
        ...
        body: 'Handled through an established payment provider rather than built from scratch.',
        items: [
      ...
      {
        title: 'Roles, permissions and teams',
        body: 'Business customers arrive as groups, not individuals.',
        items: [
      ...
      {
        title: 'Dashboards and usage tracking',
        body: 'What customers see about themselves, and what you see about them.',
        items: [
      ...
      },
      {
        ...
        body: 'Most SaaS products are bought partly for what they connect to.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'Our approach to SaaS product work',
    intro:
  ...
  process: {
    eyebrow: 'Discovery through iteration',
    heading: 'How a SaaS project runs',
    intro:
    ...
    steps: [
      {
        ...
        body: 'We work out who pays, who uses, and what the product must do before anyone will pay for it — then cut the first release down to that.',
        points: [
      ...
      },
      {
        ...
        body: 'Tenancy, permissions and the billing model are architectural decisions. They are made and written down before the first screen is built.',
        points: [
      ...
      },
      {
        ...
        body: 'The application, the billing machinery and the admin console are built together, because a SaaS product is not shippable without all three.',
        points: [
      ...
      },
      {
        ...
        body: 'The tests that matter most are the ones that prove one tenant can never see another’s data, and that billing states behave.',
        points: [
      ...
      {
        title: 'Deployment, operations and iteration',
        body: 'Launch is the start of the measurement loop. Releases become routine, and the backlog is driven by what usage data shows.',
        points: [
  ...
  engagement: {
    ...
    heading: 'Engagement options for SaaS products',
    intro:
      'Most SaaS clients start fixed-scope for the MVP and move to a dedicated team once real users arrive.',
    options: [
      {
        name: 'MVP project',
        body: 'A defined first release, priced and scheduled, covering one complete workflow plus the signup, billing and admin machinery around it.',
        bestFor: 'Best for validating a product idea with real users.',
      },
      {
        name: 'Dedicated product team',
        body: 'Ongoing engineering, design and QA capacity working to a backlog you re-prioritise each cycle.',
        bestFor: 'Best once the product is live and iterating.',
      },
      {
        name: 'Platform support',
        body: 'Monthly capacity for maintenance, dependency updates, performance work, incident support and small features.',
        bestFor: 'Best for a stable product with a small internal team.',
      },
    ],
  },
  security: {
    eyebrow: 'Security and operations',
    heading: 'Security and operational considerations',
    intro:
  ...
  faqs: [
    ...
    {
      question: 'Do you build billing and subscriptions?',
      answer:
    ...
    {
      question: 'Will the architecture scale?',
      answer:
    ...
    {
      question: 'Who owns the product and the infrastructure?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The wider practice this sits inside: product builds, integrations, automation and internal tools.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'The web application layer of a SaaS product: portals, dashboards and admin systems.',
    },
    {
      path: '/services/mobile-app-development',
      label: 'Mobile App Development',
      blurb: 'A native companion app for your SaaS product on iOS and Android.',
    },
    {
  ...
  cta: {
    title: 'Scoping a SaaS product or an MVP?',
    body: 'Get an indicative estimate for the first release, talk the idea through with our AI consultation agent, or send your notes to the team.',
  },
};
