...
export const devopsEngineering: ServiceBody = {
  ...
  problems: {
    eyebrow: 'Why teams ask for this',
    heading: 'Symptoms of a release process that needs work',
    intro:
    ...
    items: [
      {
        ...
        body: 'Files copied by hand, a migration run from someone laptop, a service restarted in the right order. It works until the person who knows the order is unavailable.',
      },
      {
        title: 'It builds on one machine and fails on another',
        body: 'Untracked dependency versions, a tool installed locally years ago, environment variables nobody documented. The build is not reproducible, so its output cannot be trusted.',
      },
      {
        title: 'Tests exist but nothing enforces them',
        body: 'A suite that passes locally, is skipped when time is short, and slowly rots. If nothing blocks a merge, the tests are documentation rather than a gate.',
      },
      {
        title: 'There is no way back from a bad release',
        body: 'Rolling back means restoring a backup and losing whatever happened since. Without a rehearsed rollback, every deployment is a one-way door.',
      },
      {
        title: 'Releases are large because releases are frightening',
        body: 'Fear of deploying leads to batching, and a batch of forty changes is far harder to diagnose than one. The fear then justifies itself.',
      },
      {
        title: 'Credentials are spread across the team',
        body: 'Keys in configuration files, tokens in chat history, one shared login. Nobody can rotate anything, because nobody knows what depends on it.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'What the service covers',
    heading: 'DevOps work this service includes',
    intro:
    ...
    groups: [
      {
        ...
        body: 'One automated path from a commit to a running deployment, visible to everyone.',
        items: [
      ...
      {
        title: 'Reproducible builds and artefacts',
        body: 'The same input producing the same output, so what you test is what you ship.',
        items: [
      ...
      },
      {
        ...
        body: 'Environments that differ only where they must, with the differences written down.',
        items: [
      ...
      },
      {
        ...
        body: 'Checks that run on every change and can actually block it.',
        items: [
      ...
      {
        title: 'Deployment, rollback and release reliability',
        body: 'Getting a change out, and getting it back if it misbehaves.',
        items: [
      ...
      {
        title: 'Infrastructure automation, monitoring and secrets',
        body: 'The operational layer that makes the pipeline safe to rely on.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'How we automate a release process',
    intro:
  ...
  process: {
    eyebrow: 'Review through handover',
    heading: 'How a DevOps engagement runs',
    intro:
      'Improvements land in usable pieces. You should have a better release path within the first stage or two, not at the end.',
    steps: [
      {
        title: 'Review of the current process',
        body: 'We document how code reaches production today, and where the time and the risk actually sit.',
        points: [
      ...
      {
        title: 'Pipeline and environment design',
        body: 'A target release path agreed on paper first, sized to the team and the risk of the application.',
        points: [
      ...
      },
      {
        ...
        body: 'The pipeline, the environments and the infrastructure code are built, in the order that removes risk soonest.',
        points: [
      ...
      {
        title: 'Verification and rehearsal',
        body: 'Before the process is trusted, we deliberately try to break it under controlled conditions.',
        points: [
      ...
      {
        title: 'Handover, monitoring and iteration',
        body: 'The team takes ownership with the documentation to run it, and we tune from real releases.',
        points: [
  ...
  engagement: {
    ...
    heading: 'Engagement options for DevOps work',
    intro:
      'Most teams want the pipeline built once and then help keeping it healthy.',
    options: [
      {
        name: 'Release process review',
        body: 'A fixed-scope review of how code currently reaches production, with a prioritised improvement plan and a baseline of your current lead time and failure rate.',
        bestFor: 'Best when you know it is slow but not why.',
      },
      {
        name: 'Pipeline implementation project',
        body: 'A defined project to build the pipeline, environments, gates and rollback path, ending with runbooks and a training session for your team.',
        bestFor: 'Best when deployment is still manual.',
      },
      {
        name: 'Ongoing automation capacity',
        body: 'Monthly engineer time for pipeline maintenance, dependency and image updates, new environments, monitoring changes and further automation.',
        bestFor: 'Best when nobody in house owns the pipeline.',
      },
    ],
  },
  limitations: {
    eyebrow: 'Scope boundaries',
    heading: 'What automation does not promise',
    intro:
    ...
    oversight: {
      title: 'How the process stays trustworthy',
      points: [
  ...
  security: {
    eyebrow: 'Security',
    heading: 'Security in the build and release path',
    intro:
  ...
  faqs: [
    {
      question: 'Can you set this up without disrupting our current releases?',
      answer:
    ...
    {
      question: 'Do we have to change our CI tool?',
      answer:
    ...
    {
      question: 'How do rollbacks work if a database migration has already run?',
      answer:
    ...
    {
      question: 'Will you have access to our production systems?',
      answer:
    ...
    {
      question: 'How long does it take to see an improvement?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The platform and environments the pipeline deploys into.',
    },
    {
      path: '/services/software-modernization',
      label: 'Software Modernization',
      blurb: 'Older systems where a safe release path is the first thing missing.',
    },
    {
      path: '/services/saas-development',
      label: 'SaaS Development',
      blurb: 'Subscription products that need frequent, low-risk releases to keep improving.',
    },
    {
      path: '/services/custom-software-development',
      label: 'Custom Software Development',
      blurb: 'The pillar service, where this pipeline is set up as part of the build.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'Web applications where preview environments make review far easier.',
    },
    {
      path: '/services/mobile-app-development',
      label: 'Mobile App Development',
      blurb: 'Automated builds and store submissions for iOS and Android releases.',
    },
  ],
  cta: {
    title: 'Tell us how you deploy today',
    body: 'Describe the steps between a finished change and a live release. Get an indicative estimate, talk it through with our AI consultation agent, or send the details to the team.',
  },
};
