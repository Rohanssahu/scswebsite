...
export const webApplicationDevelopment: ServiceContent = {
  ...
  problems: {
    ...
    heading: 'The web problems behind most briefs',
    intro:
      'Different industries, same underlying complaint: the information exists, but nobody can act on it in one place.',
    items: [
      {
        title: 'Customers email you for things they should self-serve',
        body: 'Order status, invoices, documents, renewals and support history. A customer portal moves that traffic out of your inbox and gives customers an answer at 2am.',
      },
      {
        title: 'Reporting is assembled by hand every month',
        body: 'Exports from three systems, a spreadsheet, and one person who knows how it fits together. A dashboard built on live data replaces the ritual and removes the single point of failure.',
      },
      {
        title: 'Bookings and scheduling live in a shared calendar',
        body: 'Double bookings, no-shows and manual reminders. A booking system with availability rules, confirmations and payment removes most of the coordination work outright.',
      },
      {
        title: 'A marketplace needs two sides managed at once',
        body: 'Buyers, sellers, listings, commission, disputes and payouts. Marketplaces are mostly back-office software wearing a consumer interface, and are usually underestimated as a result.',
      },
      {
        title: 'The team shares one login because there are no roles',
        body: 'Once more than a few people use a tool, "who can see and change what" becomes the design problem. Retrofitting permissions later is far more expensive than designing them in.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'Platforms and solutions',
    heading: 'What we build on the web',
    intro:
      'Application types this team builds directly, and the technologies we use to build them.',
    groups: [
      {
        title: 'Application types',
        body: 'Most projects are one of these, or a combination of two.',
        items: [
      ...
      },
      {
        ...
        body: 'Interfaces that hold up on a phone during a commute and on a wide monitor at a desk.',
        items: [
      ...
      },
      {
        ...
        body: 'The layer that decides whether the application stays maintainable a year from now.',
        items: [
      ...
      {
        title: 'Admin, authentication and permissions',
        body: 'The half of the product your own team lives in every day.',
        items: [
      ...
      },
      {
        ...
        body: 'Money movement handled through established gateways rather than reinvented.',
        items: [
      ...
      },
      {
        ...
        body: 'AI where it removes work, applied to the data your application already holds.',
        items: [
  ...
  process: {
    ...
    heading: 'How a web application project runs',
    intro:
      'Five stages, with the web-specific work in each one spelled out.',
    steps: [
      {
        title: 'Discovery and requirement analysis',
        body: 'We map the workflow the application serves and the people in it, then turn that into roles, records and screens.',
        points: [
      ...
      },
      {
        ...
        body: 'The database schema and the interface are designed together, because a screen that is awkward to build usually reflects a model that is wrong.',
        points: [
      ...
      },
      {
        ...
        body: 'Front end, API and admin tooling progress together in short cycles, with integrations built against real sandboxes rather than mocked until the end.',
        points: [
      ...
      },
      {
        ...
        body: 'Testing covers the paths that carry money, permissions and data integrity first, then everything else.',
        points: [
      ...
      },
      {
        ...
        body: 'Going live includes the boring parts: migrations, backups, monitoring and a documented way to roll back.',
        points: [
  ...
  engagement: {
    ...
    heading: 'Engagement options for web projects',
    intro:
      'Pick the arrangement that matches how settled the requirements are today.',
    options: [
      {
        name: 'Fixed-scope build',
        body: 'An agreed set of modules and screens, priced and scheduled by milestone, through to launch.',
        bestFor: 'Best for a defined portal, dashboard or booking system.',
      },
      {
        name: 'Dedicated team',
        body: 'Front-end, backend, design and QA capacity working to your backlog, re-prioritised each cycle as you learn from users.',
        bestFor: 'Best for platforms that keep evolving after launch.',
      },
      {
        name: 'Maintenance and improvement',
        body: 'Monthly capacity for fixes, dependency and framework updates, performance work and incremental features.',
        bestFor: 'Best for a live application that needs steady care.',
      },
    ],
  },
  security: {
    eyebrow: 'Security',
    heading: 'Security considerations for web applications',
    intro:
  ...
  faqs: [
    {
      question: 'What counts as a web application rather than a website?',
      answer:
    ...
    {
      question: 'Do you provide the admin panel too?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The broader practice: product builds, automation, internal tools and integration work.',
    },
    {
      path: '/services/saas-development',
      label: 'SaaS Development',
      blurb: 'When the application is sold by subscription and needs tenants, plans and usage tracking.',
    },
    {
      path: '/services/mobile-app-development',
      label: 'Mobile App Development',
      blurb: 'The companion iOS and Android app for the same platform and API.',
    },
    {
  ...
  cta: {
    title: 'Describe the workflow you want to replace',
    body: 'Run it through the estimate tool, talk it through with our AI consultation agent, or send the details to the team in Indore.',
  },
};
