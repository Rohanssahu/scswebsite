 ...
 * work against a system's API rather than as a ready-made connector, because
...
export const aiAutomationIntegration: ServiceBody = {
  ...
  problems: {
    eyebrow: 'Where automation starts',
    heading: 'The problems this work removes',
    intro:
      'If you recognise three of these, there is almost certainly a case to be made.',
    items: [
      {
        title: 'Data is re-typed between systems',
        body: 'A PDF arrives, someone reads it, someone types it into an internal tool. The transcription adds no judgement, takes real hours, and introduces errors nobody catches until later.',
      },
      {
        title: 'Approvals live in email threads',
        body: 'Requests chased over messages, decisions recorded as "I think Priya said yes", and no reliable answer to who approved what when someone asks six months later.',
      },
      {
        title: 'Documents arrive faster than anyone can read them',
        body: 'Invoices, applications, contracts, forms, delivery notes. The bottleneck is reading and classifying, and both are things software can now do a first pass on.',
      },
      {
        title: 'Systems that should talk to each other do not',
        body: 'A CRM, an accounting package and an operations tool that each hold part of the truth, reconciled by an export and a spreadsheet at the end of every month.',
      },
      {
        title: 'Work sits in a queue nobody is watching',
        body: 'Nothing failed loudly; something just stopped. Without notifications and failure handling, the discovery happens when a customer complains.',
      },
      {
        title: 'An earlier automation attempt broke trust',
        body: 'A rule-based script that silently mis-filed records, or an AI experiment that acted without review. Rebuilding usually means adding the checkpoints and audit trail that were missing.',
      },
    ],
  },
  useCases: {
    eyebrow: 'What it is used for',
    heading: 'Automations we build',
    intro:
      'Each of these leaves a human at the decision point and automates the work around it.',
    items: [
      {
        title: 'Invoice and purchase document processing',
        body: 'Extracting supplier, dates, line items and totals from documents in inconsistent formats, matching against purchase orders, and presenting exceptions for review rather than posting silently.',
      },
      {
        title: 'Application and form intake',
        body: 'Reading submitted forms and attachments, extracting fields into your system, checking completeness, and routing to the right queue with anything missing flagged.',
      },
      {
        title: 'Contract and policy review support',
        body: 'Locating clauses, summarising terms and highlighting deviations from your standard positions, so a reviewer starts from a marked-up document instead of a blank one.',
      },
      {
        title: 'Support and ticket triage',
        body: 'Classifying incoming requests by type, urgency and language, drafting a suggested reply from your knowledge base, and routing to the right team for approval.',
      },
      {
        title: 'Reporting and summary generation',
        body: 'Assembling recurring reports and summaries from live data on a schedule, drafted for a person to check and circulate rather than compiled by hand.',
      },
      {
        title: 'Cross-system record synchronisation',
        body: 'Keeping records aligned between systems that were never designed to talk, with reconciliation rules and a clear exception path when two sources disagree.',
      },
    ],
  },
  capabilities: {
    ...
    groups: [
      {
        ...
        body: 'Turning unstructured files into structured records a system can act on.',
        items: [
      ...
      },
      {
        ...
        body: 'The step that decides whether downstream automation is safe to trust.',
        items: [
      ...
      },
      {
        ...
        body: 'Multi-step processes expressed as explicit state, not as a chain of scripts.',
        items: [
      ...
      },
      {
        ...
        body: 'Custom integration with the tools your business already depends on.',
        items: [
      ...
      {
        title: 'Approvals, notifications and audit',
        body: 'The accountability layer, and the reason automation survives an internal review.',
        items: [
      ...
      {
        title: 'Failure handling and operations',
        body: 'Automations fail — providers time out, formats change, systems go down. What matters is that failure is visible.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'Our approach to AI automation',
    intro:
    ...
    steps: [
      {
        ...
        body: 'We follow the work as it happens today, including the parts nobody has written down, because those are what break naive automations.',
        points: [
      ...
      {
        title: 'Architecture and integration design',
        body: 'Which systems are touched, in what order, and what happens when one of them is unavailable.',
        points: [
      ...
      },
      {
        ...
        body: 'Built incrementally: one document type or one workflow branch at a time, running alongside the manual process.',
        points: [
      ...
      },
      {
        ...
        body: 'Tested against your real documents, including the messy ones people complain about.',
        points: [
      ...
      {
        title: 'Rollout, monitoring and expansion',
        body: 'Run in parallel with the manual process until the numbers justify switching over.',
        points: [
  ...
  integration: {
    eyebrow: 'Integration',
    heading: 'How we connect to your systems',
    intro:
  ...
  engagement: {
    ...
    heading: 'Engagement options for automation work',
    intro:
    ...
    options: [
      {
        ...
        body: 'A fixed-scope review of one process — volumes, documents, systems, exceptions and the measured manual baseline — delivered as a written recommendation with indicative effort.',
        bestFor: 'Best as a first step, and it stands alone.',
      },
      {
        name: 'Automation build',
        body: 'One process automated end to end: ingestion, extraction, workflow, approvals, integrations, audit trail and review tooling.',
        bestFor: 'Best once the assessment shows a clear case.',
      },
      {
        name: 'Ongoing automation operations',
        body: 'Monthly capacity for new document types and process branches, extraction tuning, integration changes when a vendor API moves, and incident response.',
        bestFor: 'Best for automations carrying live volume.',
      },
    ],
  },
  security: {
    eyebrow: 'Security and privacy',
    heading: 'Security considerations for automation',
    intro:
  ...
  faqs: [
    {
      question: 'Do you have ready-made connectors for our tools?',
      answer:
    ...
    {
      question: 'What if one of our systems has no API?',
      answer:
    ...
    {
      question: 'Can this run fully automatically?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The AI pillar: structured workflows, retrieval, evaluation and the controls around them.',
    },
    {
      path: '/services/machine-learning-development',
      label: 'Machine Learning Development',
      blurb: 'Classification and anomaly detection where the routing decision should be learned from history.',
    },
    {
      path: '/services/conversational-ai-development',
      label: 'Conversational AI Development',
      blurb: 'The conversational front end that feeds an automated process, and the handoff out of it.',
    },
    {
      path: '/services/custom-software-development',
      label: 'Custom Software Development',
      blurb: 'Business-process automation and internal tools more broadly, with or without AI.',
    },
    {
      path: '/services/software-modernization',
      label: 'Software Modernization',
      blurb: 'When the system being automated around needs an API before anything can connect to it.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'The review queues, dashboards and admin screens your team works the exceptions in.',
    },
  ],
  cta: {
    title: 'Which process costs you the most hours?',
    body: 'Start there. Get an indicative estimate, talk it through with our AI consultation agent, or send the details to the team in Indore.',
  },
};
