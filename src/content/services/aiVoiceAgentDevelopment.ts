 ...
 * site — voice activity detection, speech-to-text, model reasoning behind
 * strict tools, text-to-speech, turn-taking — at capability level only. No
 * provider names, no prompts, no internal architecture that would help someone
 * attack it, and no suggestion that our own agent is a client case study.
 *
...
export const aiVoiceAgentDevelopment: ServiceBody = {
  ...
  problems: {
    eyebrow: 'Why teams want voice',
    heading: 'The problems a voice agent is brought in to solve',
    intro:
      'Voice is worth the extra engineering when typing is the obstacle, or when the conversation itself is the product.',
    items: [
      {
        title: 'Enquiries arrive outside working hours and go cold',
        body: 'Someone with intent lands on your site at eleven at night, finds a contact form, and leaves. A voice agent can hold the conversation immediately and pass a structured summary to your team for the morning.',
      },
      {
        title: 'Forms collect fields but not context',
        body: 'A form gets a name and a budget range. A conversation gets what the project actually is, what has already been tried, and which constraints are non-negotiable — because it can ask the follow-up question.',
      },
      {
        title: 'Your team repeats the same first call',
        body: 'The opening qualification call is largely identical every time. Automating that first pass lets people spend their time on the conversations where judgement matters.',
      },
      {
        title: 'Typing is the wrong interface for the situation',
        body: 'Hands busy, on the move, on a phone, or simply faster at speaking than typing. In field, accessibility and mobile contexts, voice is not a novelty — it is the only usable input.',
      },
      {
        title: 'The old phone menu is actively losing customers',
        body: 'Rigid IVR trees frustrate people into hanging up or pressing zero. Replacing that logic with a system that understands intent removes the tree entirely.',
      },
    ],
  },
  useCases: {
    eyebrow: 'What it is used for',
    heading: 'Where voice agents work well',
    intro:
    ...
    items: [
      {
        ...
        body: 'Walking someone through what they need — scope, users, integrations, constraints — and recording it as structured data your team can act on, not as a paragraph someone has to re-read.',
      },
      {
        title: 'Lead qualification',
        body: 'Establishing fit, timeline and decision process in a natural conversation, then scoring and routing the enquiry to the right person with the context already attached.',
      },
      {
        title: 'Appointment and consultation booking',
        body: 'Checking availability, confirming details and creating the booking during the conversation, with confirmation sent afterwards through your existing channels.',
      },
      {
        title: 'Guided onboarding and product help',
        body: 'A spoken walkthrough for a new user, answering questions from your documentation while they are actually in the product rather than reading a help centre.',
      },
      {
        title: 'Hands-free operational assistants',
        body: 'Field and warehouse staff asking for a record, logging a status or dictating a note without stopping to find a screen.',
      },
      {
        title: 'Accessible interfaces',
        body: 'A spoken route through a service for users who cannot comfortably read or type, offered alongside the visual interface rather than instead of it.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'How it works',
    heading: 'What we build into a voice agent',
    intro:
    ...
    groups: [
      {
        title: 'The real-time speech pipeline',
        body: 'Audio in, audio out, fast enough that the pause does not feel like a fault.',
        items: [
      ...
      {
        title: 'Turn-taking and interruption',
        body: 'The part that separates a conversation from a recital, and the part most demos skip.',
        items: [
      ...
      {
        title: 'Structured conversation and tools',
        body: 'What the agent is allowed to do is defined in code, not left to the model’s discretion.',
        items: [
      ...
      {
        title: 'Handover and human escalation',
        body: 'The agent’s most important behaviour is knowing when to stop being the agent.',
        items: [
      ...
      },
      {
        ...
        body: 'Voice agents we build run in the browser and inside apps over an internet connection.',
        items: [
      ...
      {
        title: 'Operations, monitoring and cost control',
        body: 'A live voice agent consumes metered services every second it is speaking.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'Our approach to voice agents',
    intro:
  ...
  process: {
    ...
    heading: 'How a voice agent project runs',
    intro:
    ...
    steps: [
      {
        ...
        body: 'We define what the conversation is for, what it must collect, and what a successful ending looks like.',
        points: [
      ...
      },
      {
        ...
        body: 'Voice needs its own interface thinking: what the visitor sees while listening, speaking and waiting.',
        points: [
      ...
      },
      {
        ...
        body: 'The pipeline is assembled, grounded and connected to the systems that receive what the conversation produces.',
        points: [
      ...
      },
      {
        ...
        body: 'Tested against how people actually speak — accents, background noise, half-sentences and changed minds.',
        points: [
      ...
      {
        title: 'Launch, monitoring and tuning',
        body: 'The first weeks of real conversations teach more than any amount of internal testing.',
        points: [
  ...
  integration: {
    eyebrow: 'Integration',
    heading: 'Connecting a voice agent to your business',
    intro:
  ...
  limitations: {
    ...
    heading: 'What a voice agent will not do',
    intro:
  ...
  engagement: {
    ...
    heading: 'Engagement options for voice agents',
    intro:
      'Voice agents need tuning against real conversations, so most clients move to an ongoing arrangement after launch.',
    options: [
      {
        name: 'Pilot agent',
        body: 'A single conversation goal — qualification, booking or requirement collection — built, integrated and launched to a limited audience so the value can be judged on real conversations.',
        bestFor: 'Best for proving voice fits your audience.',
      },
      {
        name: 'Full agent build',
        body: 'Multiple conversation goals, deeper system integration, escalation paths and the operational tooling your team needs to run it.',
        bestFor: 'Best once a pilot has shown the pattern works.',
      },
      {
        name: 'Voice agent operations',
        body: 'Monthly capacity for transcript review, prompt and grounding updates, provider changes, cost tuning and incident response.',
        bestFor: 'Best for an agent handling live enquiries.',
      },
    ],
  },
  security: {
    eyebrow: 'Security and privacy',
    heading: 'Handling voice data responsibly',
    intro:
  ...
  faqs: [
    {
      question: 'How is this different from an IVR phone menu?',
      answer:
    ...
    {
      question: 'Can the agent make or take phone calls?',
      answer:
    ...
    {
      question: 'What happens when the agent does not understand?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The AI pillar: assistants, retrieval, structured AI workflows and the engineering around them.',
    },
    {
      path: '/services/conversational-ai-development',
      label: 'Conversational AI Development',
      blurb: 'The same conversation design applied to chat channels, or to chat and voice together.',
    },
    {
      path: '/services/ai-video-consultation-agents',
      label: 'AI Video Consultation Agents',
      blurb: 'Voice plus an avatar-led room, live transcript, chat and a structured meeting summary.',
    },
    {
      path: '/services/ai-automation-integration',
      label: 'AI Automation & Integration',
      blurb: 'Turning what a conversation collects into records, notifications and workflow steps.',
    },
    {
      path: '/services/mobile-app-development',
      label: 'Mobile App Development',
      blurb: 'Embedding a voice agent inside an iOS or Android product, with the permissions it needs.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'The web product a voice agent usually sits inside, and the admin screens behind it.',
    },
  ],
  cta: {
    title: 'Want to hear what a voice agent could do for you?',
    body: 'There is one on this site — start a consultation and talk to it. Or get an indicative estimate for your own, and send the details to the team.',
  },
};
