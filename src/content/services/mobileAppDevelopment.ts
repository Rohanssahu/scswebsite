...
export const mobileAppDevelopment: ServiceBody = {
  ...
  problems: {
    ...
    heading: 'Mobile problems worth solving properly',
    intro:
      'These are the situations that most often turn into a mobile project, and what each one really needs from the build.',
    items: [
      {
        title: 'Your customers are on mobile and your product is not',
        body: 'A responsive site covers browsing. It does not cover push notifications, camera and location access, offline use, biometric sign-in or a home-screen icon — which is usually why the conversation starts.',
      },
      {
        title: 'Field or frontline staff working away from a desk',
        body: 'Delivery drivers, technicians, inspectors and sales teams need an app that keeps working in a basement or a rural signal gap and syncs cleanly when the connection comes back.',
      },
      {
        title: 'Two platforms, one budget',
        body: 'Maintaining separate iOS and Android teams doubles the work for features that are identical on both. Cross-platform frameworks solve most of that, and we will tell you where they do not.',
      },
      {
        title: 'An app that shipped but never got maintained',
        body: 'Store policies, OS versions and SDKs move every year. An app that has not been touched in eighteen months is usually one policy update away from being pulled.',
      },
      {
        title: 'A launch that has to go through app review',
        body: 'Store rejections are rarely about code. They are about permissions, account deletion, data disclosure and payment rules — details worth designing for before the build, not after the first rejection.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'Platforms and features',
    heading: 'What we build into mobile applications',
    intro:
    ...
    groups: [
      {
        ...
        body: 'The choice is made per project, based on what the app has to do rather than on a house preference.',
        items: [
      ...
      {
        title: 'Device and native integrations',
        body: 'The hardware and OS features that make an app worth installing rather than bookmarking.',
        items: [
      ...
      {
        title: 'Accounts, payments and APIs',
        body: 'The connections that turn an interface into a working product.',
        items: [
      ...
      {
        title: 'Maps, notifications and offline behaviour',
        body: 'The three areas that most often separate an app that feels finished from one that does not.',
        items: [
      ...
      {
        title: 'AI features inside the app',
        body: 'AI is worth adding where it removes a step the user would otherwise do by hand. We build these ourselves, including the voice agent running on this site.',
        items: [
      ...
      {
        title: 'Release and post-launch',
        body: 'Shipping is the middle of the project, not the end of it.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'Our mobile development approach',
    intro:
  ...
  process: {
    eyebrow: 'Discovery through launch',
    heading: 'How a mobile project runs',
    intro:
    ...
    steps: [
      {
        ...
        body: 'We work out who opens the app, how often, and on what. That decides platform, framework and the offline strategy more than any feature list does.',
        points: [
      ...
      },
      {
        ...
        body: 'Mobile design is decided at the level of navigation and state: what is on screen, what is cached, and what happens when the network drops mid-tap.',
        points: [
      ...
      },
      {
        ...
        body: 'The app is built in cycles, with API work and native integrations progressing alongside the screens rather than behind them.',
        points: [
      ...
      },
      {
        ...
        body: 'Tested on real hardware, not only the newest phone in the office, and on the network conditions your users actually have.',
        points: [
      ...
      },
      {
        ...
        body: 'Store submission is handled as part of the project, and the first weeks after release are planned for rather than hoped through.',
        points: [
  ...
  engagement: {
    ...
    heading: 'Engagement options for mobile work',
    intro:
      'Mobile projects rarely end at launch, so the arrangement usually changes once the app is live.',
    options: [
      {
        name: 'Fixed-scope app build',
        body: 'An agreed feature set for one or both platforms, priced and scheduled, through to store submission.',
        bestFor: 'Best for a first release with a settled scope.',
      },
      {
        name: 'Dedicated mobile team',
        body: 'Mobile developers, a designer and QA working to your roadmap across releases, with priorities set by you each cycle.',
        bestFor: 'Best for products shipping continuously.',
      },
      {
        name: 'App maintenance and releases',
        body: 'Monthly capacity for OS upgrades, SDK and dependency updates, store policy changes, crash fixes and small features.',
        bestFor: 'Best for a live app that must stay compliant and stable.',
      },
    ],
  },
  security: {
    eyebrow: 'Security',
    heading: 'Security considerations in mobile builds',
    intro:
  ...
  faqs: [
    {
      question: 'Should we build native, React Native or Flutter?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The full picture: product builds, automation, internal tools and integrations across web and mobile.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'The web side of the same product — admin tooling, dashboards and customer portals.',
    },
    {
      path: '/services/saas-development',
      label: 'SaaS Development',
      blurb: 'When the mobile app is one client of a subscription product with tenants, plans and roles.',
    },
    {
  ...
  cta: {
    title: 'Have an app idea, or one that needs rescuing?',
    body: 'Get an indicative estimate in a few minutes, talk it through with our AI consultation agent, or send the details to the team directly.',
  },
};
