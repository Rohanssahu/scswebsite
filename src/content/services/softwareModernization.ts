...
export const softwareModernization: ServiceBody = {
  ...
  problems: {
    ...
    heading: 'What usually triggers a modernization project',
    intro:
      'Rarely a single dramatic failure. Usually several of these at once, accumulating until change becomes too expensive.',
    items: [
      {
        title: 'Changes take far longer than they should',
        body: 'No tests, tangled dependencies and no safe way to verify a release. The cost is not the code — it is the fortnight of caution around every deployment.',
      },
      {
        title: 'The application has become slow',
        body: 'Pages that time out, reports that lock the database, an app that takes eight seconds to open. Performance problems usually have three or four specific causes, findable through measurement.',
      },
      {
        title: 'The interface belongs to another decade',
        body: 'It works, but it is unusable on a phone, fails accessibility basics and costs you every new customer who compares it with an alternative.',
      },
      {
        title: 'It cannot integrate with anything modern',
        body: 'No API, or an API that predates the systems you now need to connect. Adding a proper interface layer is often more valuable than rewriting what is behind it.',
      },
      {
        title: 'Dependencies and platforms are out of support',
        body: 'An unsupported framework, runtime or operating system version turns every security advisory into an unanswerable question.',
      },
      {
        title: 'Nobody is left who knows how it works',
        body: 'The original developer or agency has gone and there is no documentation. Recovering that knowledge is a deliverable in its own right.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'What modernization covers',
    heading: 'The work this service includes',
    intro:
      'Which of these apply is decided by the assessment, not assumed at the proposal stage.',
    groups: [
      {
        title: 'Assessment of the existing application',
        body: 'The first engagement is almost always this, delivered as a written report.',
        items: [
      ...
      {
        title: 'Interface and usability improvement',
        body: 'Modernising what people actually touch, often without replacing what sits behind it.',
        items: [
      ...
      },
      {
        ...
        body: 'Measured before changed, so the improvement can be demonstrated rather than claimed.',
        items: [
      ...
      },
      {
        ...
        body: 'Giving an old system a modern way to be talked to.',
        items: [
      ...
      {
        title: 'Migration to modern web and mobile',
        body: 'Moving the experience forward without switching everything off at once.',
        items: [
      ...
      {
        title: 'Security review, fixes and cloud readiness',
        body: 'Reducing the exposure that accumulates in any long-lived system.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'Our modernization approach',
    intro:
  ...
  process: {
    eyebrow: 'Assessment through maintenance',
    heading: 'How a modernization project runs',
    intro:
    ...
    steps: [
      {
        ...
        body: 'We establish what the system does today, what it costs you, and what "better" would mean in terms you can measure.',
        points: [
      ...
      {
        title: 'Architecture and UI/UX planning',
        body: 'A target design and a sequence to reach it, with each step small enough to release and reverse.',
        points: [
      ...
      },
      {
        ...
        body: 'Changes are made behind boundaries, released in slices, and reconnected to the systems around them as they land.',
        points: [
      ...
      },
      {
        ...
        body: 'The central question in every release is whether anything that used to work stopped working.',
        points: [
      ...
      },
      {
        ...
        body: 'Each slice is released on its own schedule, with monitoring in place before it carries real traffic.',
        points: [
  ...
  engagement: {
    ...
    heading: 'Engagement options for modernization',
    intro:
    ...
    options: [
      {
        ...
        body: 'A fixed-scope review of the code, data and infrastructure, delivered as a written report with prioritised options and indicative effort.',
        bestFor: 'Best as a first step, and it stands alone.',
      },
      {
        name: 'Incremental modernization',
        body: 'A dedicated team working through the prioritised plan in releasable slices, with scope reviewed each cycle.',
        bestFor: 'Best for systems that must keep running throughout.',
      },
      {
        name: 'Maintenance and support',
        body: 'Monthly capacity for fixes, dependency and platform updates, performance work and small improvements.',
        bestFor: 'Best for a system that is stable but unowned.',
      },
    ],
  },
  security: {
    eyebrow: 'Security',
    heading: 'Security in an existing codebase',
    intro:
  ...
  faqs: [
    {
      question: 'Should we modernise or rebuild from scratch?',
      answer:
    ...
    {
      question: 'Can you work on software your team did not build?',
      answer:
    ...
    {
      question: 'Will the system stay live during the work?',
      answer:
    ...
    {
      question: 'What does the assessment include, and can we buy it alone?',
      answer:
    ...
    {
      question: 'Can old systems move to the cloud?',
      answer:
    ...
    {
      question: 'What if the original developers are unavailable?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The pillar service: new builds, automation, integrations and internal tools.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'Where a modernised system needs a new web front end, portal or admin console.',
    },
    {
      path: '/services/mobile-app-development',
      label: 'Mobile App Development',
      blurb: 'Adding or rebuilding the mobile experience on top of existing systems.',
    },
    {
  ...
  cta: {
    title: 'Start with an assessment, not a rebuild',
    body: 'Tell us what the system is and where it hurts. Get an indicative estimate, talk it through with our AI consultation agent, or send the details to the team.',
  },
};
