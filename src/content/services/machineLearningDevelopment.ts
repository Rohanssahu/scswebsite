...
export const machineLearningDevelopment: ServiceBody = {
  ...
  problems: {
    eyebrow: 'Where ML projects start',
    heading: 'The problems machine learning is bought to solve',
    intro:
      'Each of these is a pattern-recognition problem hiding inside an operational one.',
    items: [
      {
        title: 'Decisions are being made on intuition at scale',
        body: 'Which lead to call first, which order to inspect, which application to fast-track. Experienced staff are often good at this — but they cannot do it for fifty thousand records a week, and their reasoning leaves when they do.',
      },
      {
        title: 'Problems are found after they cost money',
        body: 'A failing component, an unusual transaction, a customer who stopped logging in weeks ago. The signal was in the data the whole time; nothing was watching for it.',
      },
      {
        title: 'Everyone sees the same thing',
        body: 'A catalogue, a course list or a content library presented identically to every user, when behaviour data could put the relevant items first.',
      },
      {
        title: 'Documents arrive faster than they can be sorted',
        body: 'Scans, forms, emails and attachments that a person opens, identifies and files. Classification is one of the most reliable places to apply ML, because the task is narrow and the labels already exist in your archive.',
      },
      {
        title: 'A model exists but nothing uses it',
        body: 'A notebook with promising numbers that never reached production. Getting a model into an application — served, versioned, monitored, retrainable — is engineering work that data science alone does not cover.',
      },
    ],
  },
  useCases: {
    eyebrow: 'What it is used for',
    heading: 'Applications we build with machine learning',
    intro:
    ...
    items: [
      {
        ...
        body: 'Estimating a future value or likelihood from historical patterns: demand, workload, renewal probability, expected duration. Useful when the estimate informs a decision rather than replaces it.',
      },
      {
        title: 'Classification and scoring',
        body: 'Assigning a category or a score to a record — priority, risk band, likely outcome — so downstream routing and triage can happen automatically for the clear cases.',
      },
      {
        title: 'Recommendation systems',
        body: 'Ranking items for a specific user from behavioural signals: what they viewed, bought, completed or skipped. Includes handling the cold-start problem for new users and new items.',
      },
      {
        title: 'Anomaly and outlier detection',
        body: 'Learning what normal looks like in your data and flagging what does not fit — unusual transactions, sensor readings, usage spikes or access patterns — for a human to review.',
      },
      {
        title: 'Document and text classification',
        body: 'Sorting incoming documents, tickets and messages into the right type, queue or language, and extracting the structured fields that follow from the type.',
      },
      {
        title: 'Segmentation and clustering',
        body: 'Grouping customers, products or behaviour into segments discovered from the data rather than assumed in advance, then making those segments usable in your tools.',
      },
    ],
  },
  capabilities: {
    eyebrow: 'What the work involves',
    heading: 'Machine learning capabilities we deliver',
    intro:
    ...
    groups: [
      {
        ...
        body: 'The stage that determines whether anything else is possible, and the one most often skipped.',
        items: [
      ...
      },
      {
        ...
        body: 'Starting simple on purpose: a baseline you can beat is worth more than a complex model you cannot explain.',
        items: [
      ...
      {
        title: 'Evaluation',
        body: 'Measured against a held-out set with metrics chosen for the decision being made, not for how good they look.',
        items: [
      ...
      {
        title: 'Integration into applications',
        body: 'A model becomes useful at the moment it appears inside a screen someone already uses.',
        items: [
      ...
      },
      {
        ...
        body: 'Models decay as the world moves. Planning for that is part of the delivery.',
        items: [
      ...
      },
      {
        ...
        body: 'The two approaches often belong in the same product, doing different jobs.',
        items: [
  ...
  approach: {
    eyebrow: 'How we work',
    heading: 'Our approach to machine learning projects',
    intro:
  ...
  process: {
    eyebrow: 'Assessment through operation',
    heading: 'How a machine learning project runs',
    intro:
      'The first stage is separable and often the only one worth committing to at the start.',
    steps: [
      {
        title: 'Discovery and data assessment',
        body: 'We look at the decision being made today and at the data available to inform it, then give an honest read on feasibility.',
        points: [
      ...
      {
        title: 'Data engineering and feature design',
        body: 'Getting from operational records to a training set is usually the longest stage, and the one that decides model quality.',
        points: [
      ...
      },
      {
        ...
        body: 'Baseline first, then improvements that must demonstrate themselves on held-out data.',
        points: [
      ...
      },
      {
        ...
        body: 'The model is wrapped in ordinary software: an API, a schema, a fallback and tests.',
        points: [
      ...
      },
      {
        ...
        body: 'Launch starts the measurement period. Without monitoring, a model quietly gets worse and nobody notices.',
        points: [
  ...
  integration: {
    eyebrow: 'Integration',
    heading: 'Getting predictions to where decisions are made',
    intro:
  ...
  limitations: {
    ...
    heading: 'What machine learning can and cannot promise',
    intro:
  ...
  engagement: {
    ...
    heading: 'Engagement options for machine learning',
    intro:
      'Nearly every client starts with the assessment, because nothing after it can be priced honestly without it.',
    options: [
      {
        name: 'Data assessment',
        body: 'A fixed-scope review of your data and the decision you want to support, delivered as a written feasibility report with options and indicative effort.',
        bestFor: 'Best as a first step, and it stands alone.',
      },
      {
        name: 'Model build and integration',
        body: 'Data pipelines, model development, evaluation, serving and integration into the application or tool that will use the output.',
        bestFor: 'Best once the assessment shows the data supports it.',
      },
      {
        name: 'Model operations',
        body: 'Monthly capacity for monitoring, drift response, retraining runs, pipeline maintenance and incremental improvement.',
        bestFor: 'Best for models already influencing real decisions.',
      },
    ],
  },
  security: {
    eyebrow: 'Security and privacy',
    heading: 'Handling training data responsibly',
    intro:
  ...
  faqs: [
    ...
    {
      question: 'Is this the same as adding ChatGPT-style AI?',
      answer:
    ...
    {
      question: 'What happens when the model gets worse over time?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'The wider AI practice: assistants, generative integrations, retrieval and structured AI workflows.',
    },
    {
      path: '/services/ai-automation-integration',
      label: 'AI Automation & Integration',
      blurb: 'Turning a prediction into an action inside your existing systems, with approvals and audit trails.',
    },
    {
      path: '/services/conversational-ai-development',
      label: 'Conversational AI Development',
      blurb: 'Where model output needs to be explained to a user in conversation rather than shown as a score.',
    },
    {
      path: '/services/web-application-development',
      label: 'Web Application Development',
      blurb: 'The dashboards and internal tools that make predictions visible to the people who act on them.',
    },
    {
      path: '/services/saas-development',
      label: 'SaaS Development',
      blurb: 'Multi-tenant products where per-customer models and usage data need careful separation.',
    },
    {
      path: '/services/custom-software-development',
      label: 'Custom Software Development',
      blurb: 'The application layer a model has to live inside to be worth anything.',
    },
  ],
  cta: {
    title: 'Start with your data, not with a model',
    body: 'Tell us what decision you want to support and what history you hold. Get an indicative estimate, talk it through with our AI consultation agent, or contact the team.',
  },
};
