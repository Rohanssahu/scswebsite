 ...
 *
 * Written from first-hand experience of building the estimator that runs behind
 * `/project-analysis` — the questionnaire, the team/hour/cost decomposition and
 * the ranges it produces. Everything specific in here is about our own system
 * or about our own delivery practice.
 *
 * It names no client, quotes no metric, cites no project, and promises no cost
 * or timeline. Where a number appears it is a *ratio between phases* or a range
 * we are willing to stand behind as a rule of thumb, and it is labelled as one.
 */
...
const body: InsightBody = {
  ...
  h1: 'How to estimate an AI app project without guessing',
  standfirst:
  ...
  basis:
    'We build our own estimator: the questionnaire at /project-analysis takes a project description and produces an indicative team, effort, cost and timeline range. Everything below comes from making that tool produce numbers we are willing to defend, and from the client conversations that followed when a number turned out to be wrong.',
  readingMinutes: 9,

  sections: [
    {
      id: 'why-ai-estimates-go-wrong',
      heading: 'Why AI estimates go wrong more often than ordinary ones',
      body: [
      ...
      note: 'The fix is not a better guess. It is deciding, before the estimate exists, what "good enough to launch" means in terms someone can check.',
    },
    {
      id: 'split-the-project',
      heading: 'Split the project into predictable and uncertain work first',
      body: [
      ...
      note: 'A useful rule of thumb from our own projects: in a first AI build, the model-facing work is usually the smaller share of total effort, and the surrounding application is the larger. If an estimate is mostly "AI development", something has been missed.',
    },
    {
      id: 'estimate-the-predictable-part',
      heading: 'Estimate the predictable part the ordinary way',
      body: [
    ...
    {
      id: 'estimate-the-uncertain-part',
      heading: 'Estimate the uncertain part as iterations, not as features',
      body: [
      ...
      note: 'This is also the honest answer to "can you guarantee accuracy". No, and neither can anyone else. What can be committed to is a measurement method, a review step and a number of improvement cycles.',
    },
    {
      id: 'the-costs-people-forget',
      heading: 'The running costs almost every first estimate omits',
      body: [
      ...
      note: 'We model these as a monthly range at a stated usage level, and we state the usage level. A running-cost figure without the assumed volume attached to it means nothing.',
    },
    {
      id: 'producing-the-range',
      heading: 'Produce a range, and say what would move it',
      body: [
      ...
      note: 'This is also what makes an estimate reviewable. A client cannot sanity-check a total, but they can absolutely tell you whether their product data is structured.',
    },
    {
      id: 'what-our-estimator-does',
      heading: 'What our own estimator does, and what it deliberately does not',
      body: [
  ...
  faqs: [
    {
      question: 'Can you give a fixed price for an AI project?',
      answer:
    ...
    {
      question: 'Why is the AI part often the cheapest part of the build?',
      answer:
    ...
    {
      question: 'How long should the evaluation cycles take?',
      answer:
    ...
    {
      question: 'What makes an AI estimate move to the high end of its range?',
      answer:
    ...
    {
      question: 'Should running costs really be in the build estimate?',
      answer:
    ...
    {
      question: 'Is the estimate from your online tool binding?',
      answer:
  ...
  related: [
    {
      ...
      blurb: 'What an AI build actually contains, from the application around the model to the review step after it.',
    },
    {
      path: '/services/machine-learning-development',
      label: 'Machine Learning Development',
      blurb: 'Where a trained model is the right answer instead of a prompt, and what that changes about the estimate.',
    },
    {
      path: '/services/custom-software-development',
      label: 'Custom Software Development',
      blurb: 'The predictable half of most AI projects: the product the model sits inside.',
    },
  ],

  cta: {
    title: 'Put a range on your own project',
    body: 'The estimator asks the questions in this article and returns an indicative team, effort, cost and timeline range. It is an estimate, not a quotation, and there is no signup.',
  },
};

export const estimatingAnAiAppProject = insightContent(body);
export default estimatingAnAiAppProject;
